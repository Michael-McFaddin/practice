//  1. Convert an array of arrays into a object.
...
//  2. Convert an array of objects into a object using the :id key from the array's objects as the keys in the new object.
...
//  3. Convert a string into a object with keys for each letter in the string and values for the number of times the letter appears in the string.
...
//  4. Convert a object into an array of arrays.
...
//  5. Convert a object into an array of objects using the keys from each object as the :id key in each of the array's objects.
...
//  6. Convert an array of strings into a object with keys for each string in the array and values for the number of times the string appears in the array.
...
//  7. Convert a object into a flat array containing all the object’s keys and values.
